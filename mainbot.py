...
while True:
    user = api.get_user('JANANIA19')
    api.update_profile(name=f'JANANI.A|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : JANANI.A|{follower_count(user)} Followers')
